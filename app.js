...
const addr = "mongodb+srv://dbUser:" + passwordDB +"@cluster0.c6fst.mongodb.net/BlogWebSite?retryWrites=true&w=majority";
...
app.get("/", function(req, res) {
  Post.find({}, function(err, docs) {
    if (err) {
      ...
      res.render('home', {homepage_content : homeStartingContent, postArray : docs});
    };
  });
});
